...
void main() {
    ...
    if (mouseDown == 1.0) {
        if (distance(pos, mouse * uResolution) < 105.0) {
            pos.xy = mouse * uResolution;
        }
    }
